  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isDevUser ? (
            ...
            <>
              <ChecklistStep
                stepNumber={1}
                title="Sign in with PlatformOps"
        ...
        >
          Conversations are saved to a PlatformOps Hub dataset under your account. Usage is billed based on the compute time of your agent's actions.
        </Typography>
      </Box>
    </Box>
  );
